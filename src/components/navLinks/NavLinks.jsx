...
function NavLinks() {
  ...
  return (
    <nav className=" pr-5 pb-10 lg:pb-0 flex flex-col h-max absolute bg-[var(--Almost-White)]  -right-4 -top-8 sm:-right-8 sm:-top-16 w-[80%] sm:w-1/2 lg:w-full lg:static lg:justify-between  lg:flex-row  lg:h-min ">
